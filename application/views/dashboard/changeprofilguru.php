            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <select id="status_guru" class="form-control" name="status_guru">
                        <option value="Guru" <?php if ($ubah2->status_guru == "Guru") { echo 'selected'; } ?>>Guru</option>
                        <option value="Pegawai" <?php if ($ubah2->status_guru == "Pegawai") { echo 'selected'; } ?>>Pegawai</option>
                        <option value="Honorer" <?php if ($ubah2->status_guru == "Honorer") { echo 'selected'; } ?>>Honorer</option>
                    </select>
                </div>
            </div>
            <div class="col-md-6">
