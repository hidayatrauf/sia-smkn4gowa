                        ...
                        <tr>
                            ...
                            <td class="text-nowrap">
                                <a href="<?= base_url('menu/form/' . $k->id_menu); ?>" class="btn btn-outline-warning">
                                    <i class="fas fa-edit pop" ata-toggle="popover" data-placement="bottom" data-content="Ubah"></i>
                                </a>
                                <a href="<?= base_url('menu/hapus/' . $k->id_menu); ?>" class="button-delete btn btn-outline-danger">
                                    <i class="fas fa-trash-alt pop" ata-toggle="popover" data-placement="bottom" data-content="Hapus"></i>
                                </a>
                            </td>
                        </tr>
                        <?php $i++; ?>
