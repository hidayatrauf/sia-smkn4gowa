...
<div class="container-fluid">
    ...
    <div class="rounded mt-4 mb-5 p-4 bg-white shadow-lg ">
        ...
        <div class="form-group">
            <label for="username">Nomor Induk / Username<span class="text-danger">*</span></label>
        ...
        <div class="row mb-3">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    <label for="id_profil">Level <span class="text-danger">*</span></label>
                    <select id="id_profil" class="form-control <?= form_error('id_profil') ? 'is-invalid' : null; ?>" name="id_profil">
                        <?php $data = $this->Default_m->getAll('tabel_profil', 'id_profil')->result();  ?>
